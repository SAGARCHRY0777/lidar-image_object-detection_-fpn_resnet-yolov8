...
class PoseResNet(nn.Module):
    ...
    def forward(self, x):
        ...
        self.kfpn_features = [up_level2, up_level3, up_level4]
        ...
        for head in self.heads:
            ...
            print("##########################################")
            print("this is after apply_kfpn")
            print("final_out: ", final_out)
            print("##########################################")
            ret[head] = final_out
        print("##########################################")
        print("contains the input in the dictionary: {}".format(self.heads.keys()))
        print('=> output heads: {}'.format(ret.keys()))
        print("##########################################")
        print("\n")
        print("##########################################")
        print("this is the ret ", ret)
        print("##########################################")
        return ret
    ### MY CHANGES
    ...
    def apply_kfpn(self, outs):
        ...
        # tensor outputs should have the same size as the heatmap output
        return ret_outs
